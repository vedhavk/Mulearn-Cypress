describe("Mentor Registration", () => {
  ...
  it("Register as College Mentor", () => {
    ...
    // Graduation Year
    cy.get('input[placeholder="e.g., 2026"]').type("2026");
  ...
  it("Register as Company Mentor and follow-ups", () => {
    fillBasicDetails(`company${Date.now()}@example.com`);
...
cy.contains("I know what I want")
  .should("be.visible")
  .click();
